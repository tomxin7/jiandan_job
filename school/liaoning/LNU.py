...
if __name__ == '__main__':
    url = "http://job.lnu.edu.cn/module/getonlines?start=0&count=16&keyword=&professionals=&recruit_type="#高校就业网的网址
    ...
    for u in url[:]:
        ...
        r_school="辽宁大学"
        r_title=title[i]
        r_trait = "LNU" + u#这里要自己写提取规则
        r_url = "http://job.lnu.edu.cn/detail/getonlinedetail?online_id=" + u
        print(r_title)
        print(r_trait)
        print(r_url)
        i += 1
